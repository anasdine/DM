...
Site 100 % statique : `index.html`, `styles.css`, `main.js`, `frames/` (193 images WebP 1920 px, 10,2 Mo — seul jeu téléchargé par les navigateurs modernes — plus un fallback JPEG 1280 px pour les navigateurs sans WebP).

## Remplacer la vidéo et régénérer les images
1. Placez la nouvelle vidéo (`video.mp4`) à la racine, puis videz `frames/`.
2. `ffmpeg -i video.mp4 -vf "fps=24,scale=1920:-2,format=yuv420p" -c:v libwebp -preset photo -quality 80 frames/f_%04d.webp`
